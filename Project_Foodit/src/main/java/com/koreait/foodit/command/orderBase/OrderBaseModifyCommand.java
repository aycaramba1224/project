...
public class OrderBaseModifyCommand implements OrderBaseCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		redirectAttributes.addFlashAttribute("orderModifyResult",orderDao.orderListModify(order_name, order_phone, order_phone2, order_phone3, order_email, order_email2, order_post, order_road1, order_no));
