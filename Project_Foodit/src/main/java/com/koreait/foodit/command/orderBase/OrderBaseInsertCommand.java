...
public class OrderBaseInsertCommand implements OrderBaseCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		// TODO Auto-generated method stub
			...
			redirectAttributes.addFlashAttribute("orderResult",orderDao.orderInsert(guest_pw, order_name, order_phone, order_phone2, order_phone3, order_email, order_email2, 
