...
public class DeliveryInsertCommand implements OrderBaseCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		// TODO Auto-generated method stub
		 OrderBaseDao orderDao = sqlSession.getMapper(OrderBaseDao.class);
			...
			orderDao.deliveryeInsert(delivery_name, delivery_phone, delivery_phone2, 
					delivery_phone3, order_post, order_road1);
