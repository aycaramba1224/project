...
public interface ProductDao {
	...
	public int productModify(String product_content, String product_name, String product_stock, 
							 int product_price, String product_img, String product_thumbImg, int product_no);	
