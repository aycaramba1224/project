...
function orderDelete(){
	if (confirm("정말 삭제할까요?")) {
		location.href='orderBaseDelete?order_id=${orderBaseDto.order_id}';
	}
}
orderBaseDelete
	...
	<form  method="post" action="orderListModify">
			<table border="1">
			    ...
			    <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br></td>
					...
					<tr>
				<td>주소
		      <input type="text" id="sample4_roadAddress" placeholder="도로명주소"  name="order_road1" size="70"value="${orderBaseDto.order_road1}" />
		      <input type="text" id="sample4_roadAddress" placeholder="지번주소"  name="order_road2" size="70"value="${orderBaseDto.order_road2}" />
		      <input type="text" id="sample4_roadAddress" placeholder="상세주소"  name="order_road3" size="70"value="${orderBaseDto.order_road3}" />
		      </td>
					</tr>
					<tr>
					<td>주문자 휴대폰번호
