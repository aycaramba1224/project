			...
			<div id="faq">		
				...
				<ul>
					<li>
						<div class="pdHead">
							<a href="#" onclick="return false;">
								<div class="pTit">배송안내</div>
							</a>
						</div>
						<div class="pdBottom" style="display:none">
							<div class="pContWrap">
								<dl>
									<dt class="pContTit">배송지</dt>
									<dd class="pContTxt">
					...
					<li>
						<div class="pdHead">
							<a href="#" onclick="return false;">
								<div class="pTit">변경/취소/반품 안내</div>
							</a>
						</div>
						<div class="pdBottom" style="display:none">
							<div class="pContWrap">
									...
									<dd class="pContTxt">
										...
										<div class="txtPar">
											...
											<div class="txtBox">
												...
												<ul class="bul_list">
													<li>
														사진만으로 제품 하자 판독이 어려운 경우 회수하여 검수 후, 처리 가능하므로 제품 보관
													</li>
												</ul>
												<ul class="bul_num_list">
													<li>
												...
												<ul class="bul_list">
													<li>FOODIT 사이트에서 안내된 email로 문의</li>
													<li>고객행복센터 1668-1920로 전화 (평일 8:00~17:00, 토요일 8:00~12:00 / 점심시간 12:00~13:00)</li>
													<li>고객행복센터 1668-1920로 문자 발송(주문번호, 사진첨부, 문제사항 기재)</li>
												</ul>
												<ul class="bul_num_list">
													<li>
														<p>④</p>
